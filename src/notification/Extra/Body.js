                            ...
                            <div className="vc_column-inner">
                              <div className="wpb_wrapper">
                                <div className="heading-title-side-border text-center Massive422ac4a3a6794118f2521b16dbf8e268">
                                  <h1 className="black-color">Notifications</h1>    <div className="title-border-container"><div className="title-border" /></div>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <table className="ui compact celled table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>8</td>
                            <td>St. Lukes</td>
                            <td><i style={{width: '33.33%', color: 'green'}} className="fa fa-check" aria-hidden="true" /><i style={{width: '33.33%', color: 'red'}} className="fa fa-times" aria-hidden="true" /></td>
                          </tr>
                          <tr>
