              ...
              <div style={{position: 'relative', left: '28%', minHeight: 50, width: '40.33%', background: '#fff', WebkitBoxShadow: '-1px 1px 13px black', zIndex: 99, borderRadius: 10}}>
                <center><br /><br />
                  <div className="heading-title-alt border text-center Massive158bbce44871d3a3c8b4f113b7ab70b2">
                    <h3 className="ctitle-border black-color">Feedback Form</h3><span className="cst-color">All fields are required.</span>
                  </div>
                  <p style={{color: 'indianred', fontWeight: 'bold', margin: 'auto'}}> Transaction Number: </p>
                  <input id="Massivee3f18aba48576bb1fa4cbc33f0a3e769-id" type="Text" disabled style={{width: '55%'}} name="quantity" className="form-control" />
                  <p style={{color: 'indianred', fontWeight: 'bold', margin: 'auto'}}> Donor Name: </p>
                  ...
                  <input id="Massivee3f18aba48576bb1fa4cbc33f0a3e769-id" type="Text" style={{width: '55%'}} name="quantity" className="form-control" />
                  <p style={{color: 'indianred', fontWeight: 'bold', margin: 'auto'}}> Blood bank Verification: </p>
                  <input id="Massivee3f18aba48576bb1fa4cbc33f0a3e769-id" type="Text" style={{width: '55%'}} name="quantity" className="form-control" />
                  <br /><br /><a type="submit" target="_blank" className="btn btn-dark-solid btn-medium">Submit</a><br /><br /><br />
                  <center />
                </center>
              </div>
              <br /><br /><br />
