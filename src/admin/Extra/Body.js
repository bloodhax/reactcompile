...
class Body extends Component {
    ...
    render() {
        return[
            <div>
            <div style={{width: 1, height: 1, display: 'inline', position: 'absolute'}}><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/index/out" /><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/n/out" /></div>
            <div style={{width: 1, height: 1, display: 'inline', position: 'absolute'}}><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/r/out" /><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/b/out" /><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/x/out" /><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/l/out" /><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/o/out" /><img height={1} width={1} style={{borderStyle: 'none'}} alt src="https://d.adroll.com/cm/g/out?google_nid=adroll5" /></div>
          </div>,
                ...
                <div className="container">
                  <div id="massive-menu" className="menuzord menuzord-responsive"><a href="javascript:void(0)" style={{display: 'none'}} className="showhide"><em /><em /><em /></a><a href="http://massive.themebucket.net/" title="Massive" className="logo-brand"><img src="wp-content/uploads/2016/01/logo-invert.png" data-retina="wp-content/uploads/2016/01/massive-dark-logo@2x.png" alt="Massive" /></a>
                    <ul id="menu-x-one-page-default" role="menubar" style={{maxHeight: 400}} className="menuzord-menu menuzord-indented scrollable">
                      ...
                      <li id="menu-item-2145" role="menuitem" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-2145"><a href="#about">USERS</a></li>
                      ...
                      <li id="menu-item-2147" role="menuitem" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-2147"><a href="#portfolio">REQUESTS</a></li>
                      <br />
                      <br />
                      <br />
                      <br />
            ...
            <div id="content">
              <div className="page-content">
                <div className="container-fluid">
                            ...
                            <div className="vc_column-inner">
                              <div className="wpb_wrapper">
                                <div className="heading-title-side-border text-center Massive422ac4a3a6794118f2521b16dbf8e268">
                                  <h1 className="black-color">BLOODHAX USERS</h1>    <div className="title-border-container"><div className="title-border" /></div>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <table className="ui compact celled table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><i style={{width: '33.33%', color: 'green'}} className="fa fa-check" aria-hidden="true" /><i style={{width: '33.33%', color: 'red'}} className="fa fa-times" aria-hidden="true" /><i style={{width: '33.33%', color: 'blue'}} className="fa fa-pencil" aria-hidden="true" /></td>
                        </tr>
                        <tr>
                      ...
                      <tfoot className="full-width">
                        <tr>
                          <th colSpan={4}>
                            <center>
                              <a style={{width: '33.33%'}} className="btn btn-dark-border btn-small " href="#">Delete Selected</a>
                              <a style={{width: '33.33%'}} className="btn btn-dark-border btn-small " href="#">Delete All</a>
                            </center>
                          </th>
                        </tr>
                      </tfoot>
                  ...
                  <a id="bucket-lift-off" href="#" className="bucket-lift-off-show"><i className="fa fa-angle-up" /></a>
        ];
    }
}
